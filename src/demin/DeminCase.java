...
//Elle gere elle meme certain evenements de la souris
//on peut en faire un Bean avec le fichier DeminCase.mf
public class DeminCase
    extends JPanel
    implements MouseListener {

  private int etat = 0; //0 = rien; 1==enfoncee; 2=drapeau; 3=?; 4=boum; 5=mine; 6=erreur de drapeau
  private boolean mine = false; //Si il y a une mine
  private boolean selected = false; //case enfoncee
  private boolean blocked = false; //bloquee
  private int chiffre = 0; //chiffre affiché s'il doit etre affiché
  ...
  public void reset() { //remise à zero des principaux paramétres
    this.etat = 0;
    this.selected = false;
    setMine(false);
    setBlocked(false);
